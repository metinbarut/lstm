...
from freqtrade.freqai.torch.PyTorchLSTMTransformerModel import PyTorchLSTMTransformerModel
from freqtrade.freqai.torch.PyTorchLSTMTransformerTrainer import PyTorchLSTMTransformerTrainer


class PyTorchLSTMTransformerRegressor(BasePyLSTMTorchRegressor):
    """
    ...
    def fit(self, data_dictionary: dict, dk: FreqaiDataKitchen, **kwargs) -> Any:
        ...
        model = PyTorchLSTMTransformerModel(
        ...
        if temp_trainer is None:
            trainer = PyTorchLSTMTransformerTrainer(
                model=model,
                optimizer=optimizer,
                criterion=criterion,
                device=self.device,
